...
/**
 * SuperSocketMaster This class gives Java students the ability to quickly open
 * a Java network socket<p>
...
public class SuperSocketMaster {
     ...
     * Once connected, both start a thread to listen for incoming clients or
     * incoming text
     *
     ...
     *
     * @param strServerIP Hostname or IP address of the server you want to
     * connect to
     * @param intPort TCP Port you want to use for your connection
     * @param listener Swing/AWT program's ActionListener. Usually "this"
     */
    ...
    /**
     * ******************************************************************
     * SocketConnection Class Creates a socket connection in either server mode
     * or client Server opens a server socket and listens for incomming
     * connections If a connection is made, make an appropriate client object
     * and starts listening for data Client opens a socket and starts listening
     * for data ****************************************************************
     */
